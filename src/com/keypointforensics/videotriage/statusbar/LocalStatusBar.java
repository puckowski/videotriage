...
public class LocalStatusBar implements StatusBar {

	/*
	 * Author: Daniel Puckowski
	 */
	
	public static final int MAXIMUM_IP_STRING_LENGTH = 100;
	...
	public LocalStatusBar(final String controllerId) {
		CONTROLLER_ID         = controllerId;
		TARGET_FRAME_COUNT    = DEFAULT_TARGET_FRAME_COUNT;
		mFramesProcessedCount = new AtomicLong();
	}
	
	public LocalStatusBar(final String controllerId, final int targetFrameCount) {
		CONTROLLER_ID         = controllerId;
	...
	public void updateStatusBar(final StatusBarBundle bundle) {	
		...
		if(count >= TARGET_FRAME_COUNT) {
			...
			bundle.getGraphicsPanel().updateStatusString("FPS: " + mFramesPerSecond + "  " + "File: " + bundle.getIp());

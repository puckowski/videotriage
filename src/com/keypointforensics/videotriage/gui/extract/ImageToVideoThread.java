...
public class ImageToVideoThread extends Thread {
	...
	public ImageToVideoThread(final String command, final int videoFrameCountOffset, final ProgressBundle progressBundle) {
		COMMAND                  = command;
	...
	private void execute() throws IOException {
		ProcessBuilder processBuilder = new ProcessBuilder("cmd.exe", "/c", "cd \"" + FileUtils.REDACT_DIRECTORY + "\" && dir && " + COMMAND);
	...
	@Override
	public void run() {	
		ThreadUtils.addThreadToHandleList("ImageToVideoThread Run", this);

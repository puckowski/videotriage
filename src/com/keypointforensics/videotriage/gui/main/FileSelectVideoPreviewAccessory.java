...
public class FileSelectVideoPreviewAccessory extends JPanel implements PropertyChangeListener {
    ...
    public FileSelectVideoPreviewAccessory() {
    ...
    public void propertyChange(PropertyChangeEvent e) {
        ...
        if (propertyName.equals(JFileChooser.SELECTED_FILE_CHANGED_PROPERTY)) {
            ...
            final String videoFilePath = WindowsVideoFrameExtractorLegacy.extractPreviewFrame(name);
            	
            if(videoFilePath != null) {
            	mImage = ImageUtils.loadBufferedImage(videoFilePath);
	            scaleImage();
	            repaint();
            }
        }

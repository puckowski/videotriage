...
public class GalleryImagePanel extends SimpleImagePanel {
	...
	private JCheckBox     SELECT_CHECK_BOX;
	...
	public GalleryImagePanel(final String imageAbsolutePath, final boolean scaleToFit, final JCheckBox selectCheckBox) {
		...
		this.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent mouseEvent) {
				if (mouseEvent.getClickCount() == SINGLE_CLICK) {
					SELECT_CHECK_BOX.setSelected(!SELECT_CHECK_BOX.isSelected());
				}
			}
		});
	}

...
public class FileListImageGallery extends BaseFileListImageGallery {
	...
	public FileListImageGallery(final ArrayList<String> listOfImageFiles) {
			...
			public void actionPerformed(ActionEvent event) {	
				new Thread() {
					...
					public void run() {
						...
						FileListImageGallery.this.dispose();
			...
			public void actionPerformed(ActionEvent event) {	
				...
				new Thread() {
					...
					public void run() {
						...
						FileListAutomaticReviewWindow automaticReviewWindow = new FileListAutomaticReviewWindow(FileListImageGallery.this, mFalsePositiveRemover);
			...
			public void actionPerformed(ActionEvent event) {
				...
				new Thread() {
					...
					public void run() {
						...
						CursorUtils.setBusyCursor(FileListImageGallery.this);
						
						performMarkAllButOneAction();
						
						CursorUtils.setDefaultCursor(FileListImageGallery.this);
	...
	protected void performSelectBackgroundAction() {
		...
		if(confirmSaveChoice == JOptionPane.OK_OPTION) {
			final ArrayList<String> listOfAllFiles = mOriginalFilePaths;

...
public class UpdatedReportPreferencesWindow extends JFrame implements ChangeListener {
	...
	public UpdatedReportPreferencesWindow(final VideoFalsePositiveRemoverByReferenceLegacy videoFalsePositiveRemoverByReferenceLegacy) {
		...
		closeWindowButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent actionEvent) {
				UpdatedReportPreferencesWindow.this.dispose();
			}			
		});
		...
		WindowRegistry.getInstance().registerFrame(this, "UpdatedReportPreferences");

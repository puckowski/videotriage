...
import com.keypointforensics.videotriage.gui.gallery.UpdatedAutomaticReviewWindow;
...
public class AutomaticReviewWindow extends JFrame implements ChangeListener {
	...
	public AutomaticReviewWindow(final ImageGallery imageGallery, final VideoFalsePositiveRemoverByReferenceLegacy videoFalsePositiveRemoverByReferenceLegacy) {
		...
		controlsPanel.setLayout(new GridLayout(13, 1));
		...
		closeWindowButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent actionEvent) {
				...
				if(proceedAutomaticChoice == JOptionPane.OK_OPTION) {			
					AutomaticReviewWindow.this.dispose();
		...
		WindowRegistry.getInstance().registerFrame(this, "AutomaticReview");
	}

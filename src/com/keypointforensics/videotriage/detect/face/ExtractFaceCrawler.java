...
public class ExtractFaceCrawler extends ExtractDetectionModule {

	/*
	 * Author: Daniel Puckowski
	 */
						
	public ExtractFaceCrawler(final GuiMain guiMain, final String databaseName, final String extractDirectory) {		

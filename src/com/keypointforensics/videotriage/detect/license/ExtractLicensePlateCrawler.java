...
public class ExtractLicensePlateCrawler extends ExtractDetectionModule {
	...
	public ExtractLicensePlateCrawler(final GuiMain guiMain, final String databaseName, final String extractDirectory) {		

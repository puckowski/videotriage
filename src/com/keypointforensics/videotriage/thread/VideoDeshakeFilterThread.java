...
public class VideoDeshakeFilterThread extends Thread {
	...
	public VideoDeshakeFilterThread(final String command, final int videoFrameCountOffset, final ProgressBundle progressBundle) {
		COMMAND                  = command;

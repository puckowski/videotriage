...
public class VideoConvertThread extends Thread {
	...
	public VideoConvertThread(final String command, final int videoFrameCountOffset, final ProgressBundle progressBundle) {
		COMMAND                  = command;
	...
	private void execute() throws IOException {
		ProcessBuilder processBuilder = new ProcessBuilder("cmd.exe", "/c", "cd \"" + FileUtils.EXPORTS_DIRECTORY + "\" && dir && " + COMMAND);

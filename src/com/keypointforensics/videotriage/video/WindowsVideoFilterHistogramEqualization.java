...
public class WindowsVideoFilterHistogramEqualization extends WindowsVideoFilter {

	private final String SUFFIX_CONTRAST_EQUALIZE = "_contrast_equalize";
	...
	public String apply(String absoluteFilePath, final int frameOffset, final ProgressBundle progressBundle) throws InterruptedException {
		...
		outputVideoAbsolutePath = outputVideoAbsolutePath.substring(0, outputVideoAbsolutePath.lastIndexOf(".")) + SUFFIX_CONTRAST_EQUALIZE +
		...
		final String command = "\"" + FileUtilsLegacy.BINARIES_DIRECTORY + WindowsVideoFrameExtractorLegacy.FFMPEG4_EXECUTABLE_NAME + "\" -threads 2 " + "-i " + "\"" + absoluteFilePath + "\""
			+ " -vf histeq=strength=0.15:intensity=0.15:antibanding=strong -c:a copy \"" + outputVideoAbsolutePath + "\"";

...
public class WindowsVideoFilterMediumContrast extends WindowsVideoFilter {

	private final String SUFFIX_MEDIUM_CONTRAST = "_medium_contrast";
	...
	public String apply(String absoluteFilePath, final int frameOffset, final ProgressBundle progressBundle) throws InterruptedException {
		...
		outputVideoAbsolutePath = outputVideoAbsolutePath.substring(0, outputVideoAbsolutePath.lastIndexOf(".")) + SUFFIX_MEDIUM_CONTRAST +
		...
		final String command = "\"" + FileUtilsLegacy.BINARIES_DIRECTORY + WindowsVideoFrameExtractorLegacy.FFMPEG4_EXECUTABLE_NAME + "\" -threads 2 " + "-i " + "\"" + absoluteFilePath + "\""
			+ " -vf curves=preset=medium_contrast -c:a copy \"" + outputVideoAbsolutePath + "\"";

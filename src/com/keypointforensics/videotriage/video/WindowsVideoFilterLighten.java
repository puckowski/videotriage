...
public class WindowsVideoFilterLighten extends WindowsVideoFilter {

	private final String SUFFIX_LIGHTER = "_lighter";
	...
	public String apply(String absoluteFilePath, final int frameOffset, final ProgressBundle progressBundle) throws InterruptedException {
		...
		outputVideoAbsolutePath = outputVideoAbsolutePath.substring(0, outputVideoAbsolutePath.lastIndexOf(".")) + SUFFIX_LIGHTER +
		...
		final String command = "\"" + FileUtilsLegacy.BINARIES_DIRECTORY + WindowsVideoFrameExtractorLegacy.FFMPEG4_EXECUTABLE_NAME + "\" -threads 2 " + "-i " + "\"" + absoluteFilePath + "\""
			+ " -vf curves=preset=lighter -c:a copy \"" + outputVideoAbsolutePath + "\"";

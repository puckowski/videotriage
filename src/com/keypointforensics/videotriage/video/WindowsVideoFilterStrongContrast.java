...
public class WindowsVideoFilterStrongContrast extends WindowsVideoFilter {

	private final String SUFFIX_STRONG_CONTRAST = "_strong_contrast";
	...
	public String apply(String absoluteFilePath, final int frameOffset, final ProgressBundle progressBundle) throws InterruptedException {
		...
		outputVideoAbsolutePath = outputVideoAbsolutePath.substring(0, outputVideoAbsolutePath.lastIndexOf(".")) + SUFFIX_STRONG_CONTRAST +
		...
		final String command = "\"" + FileUtilsLegacy.BINARIES_DIRECTORY + WindowsVideoFrameExtractorLegacy.FFMPEG4_EXECUTABLE_NAME + "\" -threads 2 " + "-i " + "\"" + absoluteFilePath + "\""
			+ " -vf curves=preset=strong_contrast -c:a copy \"" + outputVideoAbsolutePath + "\"";

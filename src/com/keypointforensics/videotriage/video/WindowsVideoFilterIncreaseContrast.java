...
public class WindowsVideoFilterIncreaseContrast extends WindowsVideoFilter {

	private final String SUFFIX_INCREASE_CONTRAST = "_increase_contrast";
	...
	public String apply(String absoluteFilePath, final int frameOffset, final ProgressBundle progressBundle) throws InterruptedException {
		...
		outputVideoAbsolutePath = outputVideoAbsolutePath.substring(0, outputVideoAbsolutePath.lastIndexOf(".")) + SUFFIX_INCREASE_CONTRAST +
		...
		final String command = "\"" + FileUtilsLegacy.BINARIES_DIRECTORY + WindowsVideoFrameExtractorLegacy.FFMPEG4_EXECUTABLE_NAME + "\" -threads 2 " + "-i " + "\"" + absoluteFilePath + "\""
			+ " -vf curves=preset=increase_contrast -c:a copy \"" + outputVideoAbsolutePath + "\"";

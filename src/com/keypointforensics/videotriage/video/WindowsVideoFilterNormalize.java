...
public class WindowsVideoFilterNormalize extends WindowsVideoFilter {

	private final String SUFFIX_CONTRAST_STRETCH = "_contrast_stretch";
	...
	public String apply(String absoluteFilePath, final int frameOffset, final ProgressBundle progressBundle) throws InterruptedException {
		...
		outputVideoAbsolutePath = outputVideoAbsolutePath.substring(0, outputVideoAbsolutePath.lastIndexOf(".")) + SUFFIX_CONTRAST_STRETCH +
		...
		final String command = "\"" + FileUtilsLegacy.BINARIES_DIRECTORY + WindowsVideoFrameExtractorLegacy.FFMPEG4_EXECUTABLE_NAME + "\" -threads 2 " + "-i " + "\"" + absoluteFilePath + "\""
			+ " -vf normalize=blackpt=black:whitept=white:smoothing=50 -c:a copy \"" + outputVideoAbsolutePath + "\"";

...
public class BlobTrackingScatterBackgroundChartBuilder extends VideoTriageChartBuilder {
	
	private final String JAVASCRIPT_FILENAME_SHORT    = "blob_tracking_scatter_background.js";
	private final String UNIQUE_DIV_NAME              = "BlobTrackingScatterBackground";
	...
	public BlobTrackingScatterBackgroundChartBuilder(final String reportRoot, final String reportPageHeader, final ArrayList<String> listOfProcessedVideos) {
	...
	private void prepareNewTimeSeriesChart() {
		...
		Utils.displayMessageDialog("Select Background", "Please select a background image for your tracking scatter chart.");
		...
		if(backgroundImageBase64Data != null) {
			...
			mChartBuilder.append(",\r\n\"sizing\": \"stretch\",");
			//"\"opacity\": 0.4,\r\n" + 
			mChartBuilder.append("\"layer\": \"below\"}],margin:{r:180,t:40,b:140,l:100},title:'Object Tracking Scatter Plot',xaxis:{title:'X Coordinate',tickangle:45},yaxis:{title:'Y Coordinate'}};var data=[{type:'scatter',mode:'markers',x:[");
		} else {

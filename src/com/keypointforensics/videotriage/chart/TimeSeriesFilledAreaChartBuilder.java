...
public class TimeSeriesFilledAreaChartBuilder extends VideoTriageChartBuilder {
	
	private final String JAVASCRIPT_FILENAME_SHORT = "time_filledarea.js";
	private final String UNIQUE_DIV_NAME           = "TimeFilledArea";
	...
	public TimeSeriesFilledAreaChartBuilder(final String reportRoot, final String reportPageHeader) {
	...
	private void prepareNewTimeSeriesChart() {
		mChartBuilder.append("var layout={margin:{r:180,t:40,b:140,l:100},title:'Time Series',xaxis:{title:'Date',tickangle:45},yaxis:{title:'Number of Keypoints'}};var data=[{type:'scatter',fill:'tozeroy',x:[");
	}

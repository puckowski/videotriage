...
public class TimeSeriesLicensePlateDetectionChartBuilder extends VideoTriageChartBuilder {

	private final String JAVASCRIPT_FILENAME_SHORT = "time_plate.js";
	private final String UNIQUE_DIV_NAME           = "TimePlate";
	...
	public TimeSeriesLicensePlateDetectionChartBuilder(final String reportRoot, final String reportPageHeader) {
	...
	private void prepareNewTimeSeriesChart() {
		mChartBuilder.append(
				"var layout={margin:{r:180,t:40,b:140,l:100},title:'Time Series License Plate Detection',xaxis:{title:'Date',tickangle:45},yaxis:{title:'Number of License Plates'}};var data=[{type:'scatter',x:[");
	}

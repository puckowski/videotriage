...
public class TimeSeriesCarDetectionChartBuilder extends VideoTriageChartBuilder {

	private final String JAVASCRIPT_FILENAME_SHORT = "time_car.js";
	private final String UNIQUE_DIV_NAME           = "TimeCar";
	...
	public TimeSeriesCarDetectionChartBuilder(final String reportRoot, final String reportPageHeader) {
	...
	private void prepareNewTimeSeriesChart() {
		mChartBuilder.append(
				"var layout={margin:{r:180,t:40,b:140,l:100},title:'Time Series Car Detection',xaxis:{title:'Date',tickangle:45},yaxis:{title:'Number of Cars'}};var data=[{type:'scatter',x:[");
	}

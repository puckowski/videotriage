...
public class TimeSeriesExplicitDetectionChartBuilder extends VideoTriageChartBuilder {

	private final String JAVASCRIPT_FILENAME_SHORT = "time_explicit.js";
	private final String UNIQUE_DIV_NAME           = "TimeExplicit";
	...
	public TimeSeriesExplicitDetectionChartBuilder(final String reportRoot, final String reportPageHeader) {
	...
	private void prepareNewTimeSeriesChart() {
		mChartBuilder.append(
				"var layout={margin:{r:180,t:40,b:140,l:100},title:'Time Series Explicit Image Detection',xaxis:{title:'Date',tickangle:45},yaxis:{title:'Number of Explicit Images'}};var data=[{type:'scatter',x:[");
	}

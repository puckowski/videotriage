...
public class TimeSeriesFaceDetectionChartBuilder extends VideoTriageChartBuilder {

	private final String JAVASCRIPT_FILENAME_SHORT = "time_face.js";
	private final String UNIQUE_DIV_NAME           = "TimeFace";
	...
	public TimeSeriesFaceDetectionChartBuilder(final String reportRoot, final String reportPageHeader) {
	...
	private void prepareNewTimeSeriesChart() {
		mChartBuilder.append(
				"var layout={margin:{r:180,t:40,b:140,l:100},title:'Time Series Face Detection',xaxis:{title:'Date',tickangle:45},yaxis:{title:'Number of Faces'}};var data=[{type:'scatter',x:[");
	}
